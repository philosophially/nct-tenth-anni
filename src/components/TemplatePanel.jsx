    ...
    return (
      ...
      >
        <div className={styles.slotInner}>
          {sel ? (
            <img className={styles.slotThumb} src={sel.albumCover} alt={sel.albumTitle} />
          ) : (
            <div className={styles.slotThumbPlaceholder} />
          )}
          <div className={styles.slotInfo}>
            {isFav ? (
              <span className={styles.slotHashtag}>⭐ My Fav</span>
            ) : (
              <>
  ...
  return (
    <div className={styles.panel}>
      ...
      <div className={styles.progressRow}>
        <span className={styles.progress}>{filled} / {total}</span>
      </div>
      <div className={styles.progressBar}>
        <div className={styles.progressFill} style={{ width: `${(filled / total) * 100}%` }} />
      </div>
